    ...
    <div class="page-content">
        ...
        <section id="createProduct" class="financemodal">
            <div class="modal-content">
                ...
                <h2 class="heading">Add New News Event</h2>
                <div id="popup-modal">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        const input = document.getElementById("NewsEventBannerImg");
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const input = document.getElementById("NewsEventImg");
        const previewContainer = document.getElementById("previewContainer");

        input.addEventListener("change", function() {
            // Clear previous previews except the default
...
<script>
    async function Save(event) {
        ...
        try {
            let NewsEventTitle = document.getElementById('NewsEventTitle').value;
            let NewsEventDescription = document.getElementById('NewsEventDescription').value;
            ...
            let res = await axios.post("/api/news-event-create", formData, config);
