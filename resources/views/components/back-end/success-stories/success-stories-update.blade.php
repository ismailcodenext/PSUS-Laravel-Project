...
<section class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <h2 class="heading">Success Stories Update</h2>
      <div id="popup-modal">
        <form>
          <div class="row">
            <div class="col-12">
...
<script>
  ...
  try {
    ...
    let res = await axios.post("/api/success-stories-by-id", {
      id: id
    }, HeaderToken());
  ...
  async function Update() {
    try {
      ...
      showLoader();
      const res = await axios.post("/api/success-stories-update", formData, {
        headers: {
