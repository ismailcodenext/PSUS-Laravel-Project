...
<script>
    ...
    async function getList() {
        try {
            ...
            let res = await axios.get("/api/success-stories-list", HeaderToken()); // Fetch brand list
            hideLoader(); // Hide loader after response

            let tableList = $("#tableList");
            tableList.empty(); // Clear previous table content

            res.data['SuccessStoriesData'].forEach(function(item, index) {
                let row = `
                        <tr data-row="${index + 1}">
                            <td>${index + 1}</td>
 <td>
                         ...
                         <td><img style="width: 100px; height: auto" alt="" src="${item['banner_image']}"></td>

                            <td>${item['event_heading']}</td>
