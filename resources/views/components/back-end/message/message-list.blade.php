...
<script>
    ...
    async function getList() {
        try {
            ...
            let res = await axios.get("/api/message-list", HeaderToken()); // Fetch brand list
            hideLoader(); // Hide loader after response

            let tableList = $("#tableList");
            tableList.empty(); // Clear previous table content

            res.data['MessageData'].forEach(function(item, index) {
                let row = `
                        <tr data-row="${index + 1}">
                            <td>${index + 1}</td>
 <td>
                         ...
                         <td><img style="width: 100px; height: auto" alt="" src="${item['img_url']}"></td>
                            ...
                            <td>${item['message_desc']}</td>
                            <td>${item['company_name']}</td>
                            <td>${item['message_details']}</td>
                            <td>${item['status']}</td>
